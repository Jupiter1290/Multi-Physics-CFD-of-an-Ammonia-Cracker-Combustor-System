...
X_h2o_flue_sim=0.309906;
X_n2_flue_sim=0.6892626;
X_h2_flue_sim=5.5010547e-11;
X_o2_flue_sim=0.00083144166;
T_flue_sim=2506.5829; %K
M_flue_sim=24.918256*0.001;%g/mol
mfr_flue=(mfr_fuel+mfr_air);
vfr_flue=mfr_flue/rho_flue_sim;
Cp_flue_sim=1685.749; %J/(kg K)
...
mfr_original=5.354693777778e-6;
%original values used:
phi_sim_aluminium=0.2585;phi_sim_titanium=0.2635;
recirculated_mfr_flue_fromSim_aluminum=1.3842e-06;
recirculated_mfr_flue_fromSim_titanium=1.4110e-06;